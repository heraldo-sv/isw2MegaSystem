<form method="post" v-on:submit.prevent="dtlCreateKeep">
    <div class="modal fade" id="changeDetail">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <input type="submit" class="btn btn-danger" value="Cambio de etapa">
                </div>
            </div>
        </div>
    </div>
