            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        ...
                        <a id="new" href="#" class="btn btn-primary pull-right" data-toggle="modal" data-target="#create"> Nuevo proveedor</a>
                    ...
                    <div class="x_content">
                        <div class="col-sm-12">
                            ...
                            @include('admin.catalogos.proveedor.create')
                            @include('admin.catalogos.proveedor.update')
                        </div>
                    </div>
                </div>
            </div>
...
@push('scripts')
    <script src="{{ asset("admin/catalogo/proveedor.js") }}"></script>
@endpush