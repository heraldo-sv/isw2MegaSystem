<div class="col-md-3 left_col">
    <div class="left_col scroll-view">
        <div class="navbar nav_title" style="border: 0;">
            <a href="{{ url('/') }}" class="site_title"><i class="fa fa-gg-circle"></i> <span>MegaSystem IT</span></a>
        </div>
        ...
        <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
            ...
            <div class="menu_section">
                ...
                <ul class="nav side-menu">
                    ...
                    <li><a><i class="fa fa-users"></i> Gestiones <span class="fa fa-chevron-down"></span></a>
                        <ul class="nav child_menu">
                            <li><a href="{{ url('/clientes') }}">Clientes</a></li>
                            <li><a href="{{ url('/vehiculos') }}">Vehiculos</a></li>
                        </ul>
                    </li>
                    <li><a><i class="fa fa-calendar-check-o"></i> Procesos <span class="fa fa-chevron-down"></span></a>
                        <ul class="nav child_menu">
